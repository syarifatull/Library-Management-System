...
{ Program sistem manajemen perpustakaan yang dikendalikan dengan
  perintah-perintah, dan menyimpan data dalam bentuk file CSV }


uses
    uType, uAkun, uBuku, uPinjam, uHilang, uTambah, uStat, uFile, uHash, uDEBUG;
